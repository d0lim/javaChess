...
public class GameManager {
	...
	static Coordinate[] kingF = new Coordinate[4];
	...
	public void setPosition2(ChessPanel boardPiece[][])
	{
		...
		boardPiece[1][6].setPiece(new Pawn(1, 6), 1);
		boardPiece[1][7].setPiece(new Pawn(1, 7), 1);
		boardPiece[1][8].setPiece(new Pawn(1, 8), 1);
		boardPiece[1][9].setPiece(new Pawn(1, 9), 1);
		boardPiece[1][10].setPiece(new Pawn(1, 10), 1);
		boardPiece[0][4].setPiece(new Knight(0, 4), 1);
		boardPiece[0][9].setPiece(new Knight(0, 9), 1);
		boardPiece[0][3].setPiece(new Rook(0, 3), 1);
		boardPiece[0][10].setPiece(new Rook(0, 10), 1);
		boardPiece[0][5].setPiece(new Bishop(0, 5), 1);
		boardPiece[0][8].setPiece(new Bishop(0, 8), 1);
		boardPiece[0][6].setPiece(new Queen(0, 6), 1);
		boardPiece[0][7].setPiece(new King(0, 7), 1);
		kingF[1] = new Coordinate(0, 7);
		
		boardPiece[12][3].setPiece(new Pawn(12, 3), 0);
		boardPiece[12][4].setPiece(new Pawn(12, 4), 0);
		boardPiece[12][5].setPiece(new Pawn(12, 5), 0);
		boardPiece[12][6].setPiece(new Pawn(12, 6), 0);
		boardPiece[12][7].setPiece(new Pawn(12, 7), 0);
		boardPiece[12][8].setPiece(new Pawn(12, 8), 0);
		boardPiece[12][9].setPiece(new Pawn(12, 9), 0);
		boardPiece[12][10].setPiece(new Pawn(12, 10), 0);
		...
		kingF[0] = new Coordinate(13, 7);
		
		boardPiece[3][1].setPiece(new Pawn(3, 1), 2);
		boardPiece[4][1].setPiece(new Pawn(4, 1), 2);
		boardPiece[5][1].setPiece(new Pawn(5, 1), 2);
		boardPiece[6][1].setPiece(new Pawn(6, 1), 2);
		boardPiece[7][1].setPiece(new Pawn(7, 1), 2);
		boardPiece[8][1].setPiece(new Pawn(8, 1), 2);
		boardPiece[9][1].setPiece(new Pawn(9, 1), 2);
		boardPiece[10][1].setPiece(new Pawn(10, 1), 2);
		boardPiece[4][0].setPiece(new Knight(4, 0), 2);
		boardPiece[9][0].setPiece(new Knight(9, 0), 2);
		boardPiece[3][0].setPiece(new Rook(3, 0), 2);
		boardPiece[10][0].setPiece(new Rook(10, 0), 2);
		boardPiece[5][0].setPiece(new Bishop(5, 0), 2);
		boardPiece[8][0].setPiece(new Bishop(8, 0), 2);
		boardPiece[6][0].setPiece(new Queen(6, 0), 2);
		boardPiece[7][0].setPiece(new King(7, 0), 2);
		kingF[2] = new Coordinate(7, 0);
		
		boardPiece[3][12].setPiece(new Pawn(3, 12), 3);
		boardPiece[4][12].setPiece(new Pawn(4, 12), 3);
		boardPiece[5][12].setPiece(new Pawn(5, 12), 3);
		boardPiece[6][12].setPiece(new Pawn(6, 12), 3);
		boardPiece[7][12].setPiece(new Pawn(7, 12), 3);
		boardPiece[8][12].setPiece(new Pawn(8, 12), 3);
		boardPiece[9][12].setPiece(new Pawn(9, 12), 3);
		boardPiece[10][12].setPiece(new Pawn(10, 12), 3);
